...
public class AddConsultant extends javax.swing.JFrame {
    ...
    ViewConsultants v = new ViewConsultants();
    ...
    public AddConsultant(EmployeeClass employeeData, EmployeeClass edata) throws ParseException {
        initComponents();
        ...
        pass1.setVisible(false);
        email1.setVisible(false);
        heading.setText("Update Details of Consultant");
        isUpdate++;
    ...
    public AddConsultant(EmployeeClass edata) throws ParseException {
        initComponents();
        name1.setVisible(false);
        age1.setVisible(false);
        address1.setVisible(false);
    ...
    private void initComponents() {
        ...
        heading.setText("Add Consultant");
        ...
        deletebtn.setText("Remove Consultant");
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
        ...
        if (age.getText().equals("")) {
            age1.setText("Age required");
        }else if(name.getText().equals("")){
            name1.setText("Name Required");
        }else if(contact.getText().equals("")){
            contact1.setText("Contact Required");
        }else if(email.getText().equals("")){
            email1.setText("Email Required");
            ...
            if (isUpdate == 0) {
                ...
                try {
                    ...
                    if (user.equals("") && phn.equals("") && age.getText().equals("") && adrs.equals("") && pass.equals("") && mail.equals("")) {
                        ...
                        ViewConsultants view = new ViewConsultants(edata);
        ...
        if (edata.getRole() != 2) {
            ...
            try {
                ...
                if (ps.executeUpdate() > 0) {
                    JOptionPane.showMessageDialog(null, "Consultant '" + employeeData.getName() + "' Removed Succesfully");
                    ViewConsultants view = new ViewConsultants(edata);
                    view.setVisible(true);
                    this.dispose();
                ...
                Logger.getLogger(ViewConsultants.class
                        .getName()).log(Level.SEVERE, null, ex);
            }
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddConsultant.class
