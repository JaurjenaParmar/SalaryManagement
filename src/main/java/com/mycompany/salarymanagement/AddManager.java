...
public class AddManager extends javax.swing.JFrame {
    ...
    ViewManagers v = new ViewManagers();
    ...
    public AddManager(EmployeeClass employeeData, EmployeeClass edata) throws ParseException {
        initComponents();
        ...
        pass1.setVisible(false);
        email1.setVisible(false);
        heading.setText("Update Details of Manager");
        isUpdate++;
    ...
    public AddManager(EmployeeClass edata) throws ParseException {
        initComponents();
        name1.setVisible(false);
        age1.setVisible(false);
        address1.setVisible(false);
    ...
    private void initComponents() {
        ...
        deletebtn.setText("Remove Manager");
        ...
        if (user.equals("") || phn.equals("") || age.getText().equals("") || adrs.equals("") || pass.equals("") || mail.equals("")) {
            ...
            if (isUpdate == 0) {
                ...
                try {
                    ...
                    Logger.getLogger(AddManager.class
                ...
                try {
                    ...
                    ViewManagers view = new ViewManagers(edata);
    ...
    private void deletebtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deletebtnActionPerformed
        // TODO add your handling code here:
        if (ViewManagers.tableClicked == true) {
            ...
            try {
                ...
                if (ps.executeUpdate() > 0) {
                    JOptionPane.showMessageDialog(null, "Manager '" + employeeData.getName() + "' Removed Succesfully");
                    ViewManagers view = new ViewManagers(edata);
                    view.setVisible(true);
                    this.dispose();
                ...
                Logger.getLogger(ViewManagers.class
                        .getName()).log(Level.SEVERE, null, ex);
            }
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddManager.class
