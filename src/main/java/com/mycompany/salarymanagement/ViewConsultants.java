 ...
 * @author parma
 */
public class ViewConsultants extends javax.swing.JFrame {
    ...
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
        ...
        try {
            // TODO add your handling code here:
            if (edata.getRole() == 0 || edata.getRole() == 1) {
                ...
                AddConsultant add;
                try {
                    add = new AddConsultant(data, edata);
                    add.setVisible(true);
                } catch (ParseException ex) {
                    Logger.getLogger(ViewConsultants.class.getName()).log(Level.SEVERE, null, ex);
                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewConsultants.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewConsultants().setVisible(true);
            }
        });
    }
