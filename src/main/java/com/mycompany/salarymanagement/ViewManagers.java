 ...
 * @author parma
 */
public class ViewManagers extends javax.swing.JFrame {
    ...
    ViewManagers(EmployeeClass edata) {
        initComponents();
        this.edata = edata;
        edata.getId();
        edata.getName();
    ...
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
        ...
        if (edata.getRole() == 0) {
            ...
            try {
                ...
                AddManager add;
                try {
                    add = new AddManager(data, edata);
                    add.setVisible(true);
                } catch (ParseException ex) {
                    Logger.getLogger(ViewManagers.class.getName()).log(Level.SEVERE, null, ex);
                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewManagers.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewManagers().setVisible(true);
            }
        });
    }
